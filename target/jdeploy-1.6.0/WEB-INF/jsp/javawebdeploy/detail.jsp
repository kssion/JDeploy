		...
		<div class="row">
				<div class="col s12 m6 l4">
					<div class="card">
						...
						<div class="card-action">
							<a href="#" class="btn-showlog" data-wsurl="ws://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}/log?uuid=${detail.uuid}">查看日志</a>
						</div>
					</div>
				</div>
		</div>
